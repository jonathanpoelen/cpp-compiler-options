...
function tovalues(values, disable_other_options)
  if values then
    ...
    return {
      ...
      ["diagnostics_show_template_tree"] = values["diagnostics_show_template_tree"] or values["jln-diagnostics-show-template-tree"] or (disable_other_options and "" or _flag_names["diagnostics_show_template_tree"][get_config("jln-diagnostics-show-template-tree")]),
      ["elide_type"] = values["elide_type"] or values["jln-elide-type"] or (disable_other_options and "" or _flag_names["elide_type"][get_config("jln-elide-type")]),
      ...
      ["msvc_isystem_with_template_from_non_external"] = values["msvc_isystem_with_template_from_non_external"] or values["jln-msvc-isystem-with-template-from-non-external"] or (disable_other_options and "" or _flag_names["msvc_isystem_with_template_from_non_external"][get_config("jln-msvc-isystem-with-template-from-non-external")]),
      ["noexcept_warnings"] = values["noexcept_warnings"] or values["jln-noexcept-warnings"] or (disable_other_options and "" or _flag_names["noexcept_warnings"][get_config("jln-noexcept-warnings")]),
      ...
      ["rtti"] = values["rtti"] or values["jln-rtti"] or (disable_other_options and "" or _flag_names["rtti"][get_config("jln-rtti")]),
      ...
      ["stl_debug"] = values["stl_debug"] or values["jln-stl-debug"] or (disable_other_options and "" or _flag_names["stl_debug"][get_config("jln-stl-debug")]),
      ...
      ["windows_abi_compatibility_warnings"] = values["windows_abi_compatibility_warnings"] or values["jln-windows-abi-compatibility-warnings"] or (disable_other_options and "" or _flag_names["windows_abi_compatibility_warnings"][get_config("jln-windows-abi-compatibility-warnings")]),
      ...
      ["cxx"] = values["cxx"] or (not disable_other_options and _get_extra("jln-cxx")) or nil,
      ["cxx_version"] = values["cxx_version"] or (not disable_other_options and _get_extra("jln-cxx-version")) or nil,
