...
local _flag_names = {
  ...
  option("jln-cxx", {showmenu=true, description="Path or name of the compiler for jln function", default=""})
  option("jln-ld", {showmenu=true, description="Path or name of the linker for jln function", default=""})
  option("jln-cxx-version", {showmenu=true, description="Force the compiler version for jln function", default=""})
end
