...
function(jln_flags)
  ...
  if (  ( CMAKE_CXX_COMPILER_ID MATCHES "GNU" OR CMAKE_CXX_COMPILER_ID MATCHES "Clang" ) )
    ...
    if (  NOT ( JLN_FLAGS_LINKER STREQUAL "default") )
      ...
      elseif (  JLN_FLAGS_LINKER STREQUAL "bfd" )
        list(APPEND LINK_FLAGS  "-fuse-ld=bfd")
      elseif (  ( JLN_FLAGS_LINKER STREQUAL "gold" OR NOT ( CMAKE_CXX_COMPILER_ID MATCHES "GNU" AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "9.0" ) ) ) )
        list(APPEND LINK_FLAGS  "-fuse-ld=gold")
      else()
        list(APPEND LINK_FLAGS  "-fuse-ld=lld")
      endif()
    ...
    if (  NOT ( JLN_FLAGS_LTO STREQUAL "default") )
      ...
      elseif (  ( JLN_FLAGS_LTO STREQUAL "linker_plugin" AND ( CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "6.0" ) ) ) )
