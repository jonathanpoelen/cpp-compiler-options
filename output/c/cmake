...
function(jln_c_flags)
  ...
  if (  ( (CMAKE_CXX_COMPILER_ID MATCHES "GNU") OR (CMAKE_CXX_COMPILER_ID MATCHES "Clang") OR (CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND "${MSVC}") ) )
    if (  NOT ( JLN_FLAGS_WARNINGS STREQUAL "default") )
      if (  JLN_FLAGS_WARNINGS STREQUAL "off" )
        ...
        if (  (CMAKE_CXX_COMPILER_ID MATCHES "GNU") )
          ...
          if (  ( (CMAKE_CXX_COMPILER_ID MATCHES "Clang") OR (CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND "${MSVC}") ) )
    ...
    if (  NOT ( JLN_FLAGS_CONTROL_FLOW STREQUAL "default") )
      if (  JLN_FLAGS_CONTROL_FLOW STREQUAL "off" )
        ...
        if (  ( ( (CMAKE_CXX_COMPILER_ID MATCHES "GNU") AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "8.0" ) ) OR (CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND "${MSVC}") ) )
          ...
          if (  ( JLN_FLAGS_CONTROL_FLOW STREQUAL "allow_bugs" AND (CMAKE_CXX_COMPILER_ID MATCHES "Clang") ) )
    ...
    if (  NOT ( JLN_FLAGS_COLOR STREQUAL "default") )
      if (  ( ( (CMAKE_CXX_COMPILER_ID MATCHES "GNU") AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "4.9" ) ) OR (CMAKE_CXX_COMPILER_ID MATCHES "Clang") OR (CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND "${MSVC}") ) )
    ...
    if (  NOT ( JLN_FLAGS_DIAGNOSTICS_FORMAT STREQUAL "default") )
      if (  JLN_FLAGS_DIAGNOSTICS_FORMAT STREQUAL "fixits" )
        if (  ( ( (CMAKE_CXX_COMPILER_ID MATCHES "GNU") AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "7.0" ) ) OR ( (CMAKE_CXX_COMPILER_ID MATCHES "Clang") AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "5.0" ) ) OR ( (CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND "${MSVC}") AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "5.0" ) ) ) )
    ...
    if (  NOT ( JLN_FLAGS_LINKER STREQUAL "default") )
      if (  JLN_FLAGS_LINKER STREQUAL "native" )
        ...
        if (  JLN_FLAGS_LINKER STREQUAL "bfd" )
          ...
          if (  ( JLN_FLAGS_LINKER STREQUAL "gold" OR ( (CMAKE_CXX_COMPILER_ID MATCHES "GNU") AND NOT ( NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "9.0" ) ) ) ) )
            list(APPEND LINK_FLAGS  "-fuse-ld=gold")
          else()
            if (  NOT ( JLN_FLAGS_LTO STREQUAL "default") )
              if (  ( NOT ( JLN_FLAGS_LTO STREQUAL "off" ) AND (CMAKE_CXX_COMPILER_ID MATCHES "GNU") ) )
                list(APPEND LINK_FLAGS  "-fuse-ld=gold")
              else()
                list(APPEND LINK_FLAGS  "-fuse-ld=lld")
              endif()
    ...
    if (  NOT ( JLN_FLAGS_LTO STREQUAL "default") )
      if (  JLN_FLAGS_LTO STREQUAL "off" )
        ...
        if (  (CMAKE_CXX_COMPILER_ID MATCHES "GNU") )
          ...
          if (  ( JLN_FLAGS_LTO STREQUAL "thin" AND (CMAKE_CXX_COMPILER_ID MATCHES "Clang") AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "6.0" ) ) )
      ...
      if (  JLN_FLAGS_SHADOW_WARNINGS STREQUAL "off" )
        ...
        if (  JLN_FLAGS_SHADOW_WARNINGS STREQUAL "on" )
          ...
          if (  JLN_FLAGS_SHADOW_WARNINGS STREQUAL "all" )
            ...
            if (  ( (CMAKE_CXX_COMPILER_ID MATCHES "GNU") AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "7.1" ) ) )
  ...
  if (  ( (CMAKE_CXX_COMPILER_ID MATCHES "MSVC") OR (CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND "${MSVC}") ) )
