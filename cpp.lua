...
function jln_newoptions(defaults)
  ...
  newoption{trigger="jln-cxx", description="Path or name of the compiler for jln function"}
  newoption{trigger="jln-ld", description="Path or name of the linker for jln function"}
  newoption{trigger="jln-cxx-version", description="Force the compiler version for jln function"}
end
