...
function jln_newoptions(defaults)
  ...
  newoption{trigger="jln-msvc-isystem-with-template-instantiations-treated-as-non-external", allowed={{'default'}, {'off'}, {'on'}}, description="Allows warnings from external headers when they occur in a template that\'s instantiated in your code. (requires msvc_isystem)."}
