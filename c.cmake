...
function(jln_c_init_flags)
  jln_c_parse_arguments(JLN_DEFAULT_FLAG "VERBOSE;COLOR;CONTROL_FLOW;CONVERSION_WARNINGS;COVERAGE;COVERED_SWITCH_DEFAULT_WARNINGS;CPU;DEBUG;DIAGNOSTICS_FORMAT;EXCEPTIONS;FIX_COMPILER_ERROR;FLOAT_SANITIZERS;INTEGER_SANITIZERS;LINKER;LTO;MSVC_CONFORMANCE;MSVC_CRT_SECURE_NO_WARNINGS;MSVC_ISYSTEM;OPTIMIZATION;OTHER_SANITIZERS;PEDANTIC;PIE;RELRO;REPRODUCIBLE_BUILD_WARNINGS;SANITIZERS;SHADOW_WARNINGS;STACK_PROTECTOR;STL_FIX;SUGGESTIONS;SWITCH_WARNINGS;WARNINGS;WARNINGS_AS_ERROR;WHOLE_PROGRAM;WINDOWS_BIGOBJ;AUTO_PROFILE" ${ARGN})
...
function(jln_c_flags)
  ...
  set(CXX_FLAGS "")
  set(LINK_LINK "")
  jln_c_parse_arguments(JLN_FLAGS "DISABLE_OTHERS;C_VAR;LINK_VAR;COLOR;CONTROL_FLOW;CONVERSION_WARNINGS;COVERAGE;COVERED_SWITCH_DEFAULT_WARNINGS;CPU;DEBUG;DIAGNOSTICS_FORMAT;EXCEPTIONS;FIX_COMPILER_ERROR;FLOAT_SANITIZERS;INTEGER_SANITIZERS;LINKER;LTO;MSVC_CONFORMANCE;MSVC_CRT_SECURE_NO_WARNINGS;MSVC_ISYSTEM;OPTIMIZATION;OTHER_SANITIZERS;PEDANTIC;PIE;RELRO;REPRODUCIBLE_BUILD_WARNINGS;SANITIZERS;SHADOW_WARNINGS;STACK_PROTECTOR;STL_FIX;SUGGESTIONS;SWITCH_WARNINGS;WARNINGS;WARNINGS_AS_ERROR;WHOLE_PROGRAM;WINDOWS_BIGOBJ" ${ARGN})
  ...
  if (  ( JLN_GCC_C_COMPILER OR JLN_CLANG_C_COMPILER OR JLN_CLANG_CL_C_COMPILER ) )
    if (  NOT ( JLN_FLAGS_WARNINGS STREQUAL "default") )
      if (  JLN_FLAGS_WARNINGS STREQUAL "off" )
        ...
        if (  JLN_GCC_C_COMPILER )
          ...
          if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "4.7" ) )
            ...
            if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "4.8" ) )
              if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "4.9" ) )
                list(APPEND CXX_FLAGS  "-Wfloat-conversion")
                if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "5.1" ) )
                  list(APPEND CXX_FLAGS  "-Wformat-signedness" "-Warray-bounds=2")
                  if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "6.1" ) )
                    list(APPEND CXX_FLAGS  "-Wduplicated-cond" "-Wnull-dereference")
                    if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "7.0" ) )
                      if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "7.1" ) )
        ...
        if (  ( JLN_FLAGS_WARNINGS STREQUAL "strict" OR JLN_FLAGS_WARNINGS STREQUAL "very_strict" ) )
          if (  ( JLN_GCC_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "8.0" ) ) )
      ...
      if (  JLN_FLAGS_WARNINGS_AS_ERROR STREQUAL "on" )
        ...
        if (  JLN_FLAGS_WARNINGS_AS_ERROR STREQUAL "basic" )
          ...
          if (  JLN_GCC_C_COMPILER )
            ...
            if (  ( JLN_CLANG_C_COMPILER OR JLN_CLANG_CL_C_COMPILER ) )
              list(APPEND CXX_FLAGS  "-Werror=array-bounds" "-Werror=division-by-zero")
              if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "3.4" ) )
    ...
    if (  NOT ( JLN_FLAGS_SUGGESTIONS STREQUAL "default") )
      if (  NOT ( JLN_FLAGS_SUGGESTIONS STREQUAL "off" ) )
        if (  JLN_GCC_C_COMPILER )
          ...
          if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "5.0" ) )
            if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "5.1" ) )
      ...
      if (  JLN_FLAGS_SANITIZERS STREQUAL "off" )
        ...
        if (  JLN_CLANG_CL_C_COMPILER )
          ...
          if (  JLN_CLANG_C_COMPILER )
            if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "3.1" ) )
              ...
              if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "6.0" ) )
    ...
    if (  NOT ( JLN_FLAGS_CONTROL_FLOW STREQUAL "default") )
      if (  JLN_FLAGS_CONTROL_FLOW STREQUAL "off" )
        ...
        if (  ( ( JLN_GCC_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "8.0" ) ) OR NOT ( JLN_GCC_C_COMPILER ) ) )
    ...
    if (  NOT ( JLN_FLAGS_COLOR STREQUAL "default") )
      if (  ( ( JLN_GCC_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "4.9" ) ) OR JLN_CLANG_C_COMPILER OR JLN_CLANG_CL_C_COMPILER ) )
    ...
    if (  NOT ( JLN_FLAGS_REPRODUCIBLE_BUILD_WARNINGS STREQUAL "default") )
      if (  ( JLN_GCC_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "4.9" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_DIAGNOSTICS_FORMAT STREQUAL "default") )
      if (  JLN_FLAGS_DIAGNOSTICS_FORMAT STREQUAL "fixits" )
        if (  ( ( JLN_GCC_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "7.0" ) ) OR ( JLN_CLANG_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "5.0" ) ) OR ( JLN_CLANG_CL_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "5.0" ) ) ) )
          list(APPEND CXX_FLAGS  "-fdiagnostics-parseable-fixits")
        endif()
      else()
        if (  JLN_FLAGS_DIAGNOSTICS_FORMAT STREQUAL "patch" )
          if (  ( JLN_GCC_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "7.0" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_LINKER STREQUAL "default") )
      if (  JLN_FLAGS_LINKER STREQUAL "native" )
        ...
        if (  JLN_FLAGS_LINKER STREQUAL "bfd" )
          ...
          if (  ( JLN_FLAGS_LINKER STREQUAL "gold" OR ( JLN_GCC_C_COMPILER AND NOT ( NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "9.0" ) ) ) ) )
            list(APPEND LINK_FLAGS  "-fuse-ld=gold")
          else()
    ...
    if (  NOT ( JLN_FLAGS_LTO STREQUAL "default") )
      if (  JLN_FLAGS_LTO STREQUAL "off" )
        ...
        if (  JLN_GCC_C_COMPILER )
          ...
          if (  ( JLN_FLAGS_LTO STREQUAL "thin" AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "6.0" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_SHADOW_WARNINGS STREQUAL "default") )
      if (  JLN_FLAGS_SHADOW_WARNINGS STREQUAL "off" )
        ...
        if (  ( JLN_CLANG_CL_C_COMPILER OR ( JLN_CLANG_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "8.0" ) ) ) )
        ...
        if (  JLN_FLAGS_SHADOW_WARNINGS STREQUAL "on" )
          ...
          if (  JLN_FLAGS_SHADOW_WARNINGS STREQUAL "all" )
            ...
            if (  ( JLN_GCC_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "7.1" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_FLOAT_SANITIZERS STREQUAL "default") )
      if (  ( ( JLN_GCC_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "5.0" ) ) OR ( JLN_CLANG_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "5.0" ) ) OR JLN_CLANG_CL_C_COMPILER ) )
    ...
    if (  NOT ( JLN_FLAGS_INTEGER_SANITIZERS STREQUAL "default") )
      if (  ( ( JLN_CLANG_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "5.0" ) ) OR JLN_CLANG_CL_C_COMPILER ) )
  ...
  if (  ( JLN_GCC_C_COMPILER OR JLN_CLANG_C_COMPILER OR JLN_CLANG_CL_C_COMPILER OR JLN_ICC_C_COMPILER ) )
  ...
  if (  ( JLN_GCC_C_COMPILER OR JLN_CLANG_C_COMPILER ) )
    ...
    if (  NOT ( JLN_FLAGS_WHOLE_PROGRAM STREQUAL "default") )
      if (  JLN_FLAGS_WHOLE_PROGRAM STREQUAL "off" )
        ...
        if (  ( JLN_CLANG_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "3.9" ) ) )
        ...
        if (  JLN_GCC_C_COMPILER )
          ...
          if (  JLN_CLANG_C_COMPILER )
            if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "3.9" ) )
              if (  NOT ( JLN_FLAGS_LTO STREQUAL "default") )
        ...
        if (  JLN_FLAGS_STACK_PROTECTOR STREQUAL "strong" )
          if (  JLN_GCC_C_COMPILER )
            if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "4.9" ) )
              ...
              if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "8.0" ) )
            ...
            if (  JLN_CLANG_C_COMPILER )
              ...
              if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "11.0" ) )
                list(APPEND CXX_FLAGS  "-fstack-clash-protection")
                list(APPEND LINK_FLAGS  "-fstack-clash-protection")
              endif()
            endif()
      ...
      if (  JLN_FLAGS_RELRO STREQUAL "off" )
        ...
        if (  JLN_FLAGS_RELRO STREQUAL "on" )
          ...
          if (  JLN_FLAGS_RELRO STREQUAL "full" )
            ...
            if (  NOT ( JLN_FLAGS_LINKER STREQUAL "default") )
              if (  NOT ( ( JLN_FLAGS_LINKER STREQUAL "gold" OR ( JLN_GCC_C_COMPILER AND NOT ( NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "9.0" ) ) ) OR ( JLN_FLAGS_LINKER STREQUAL "native" AND JLN_GCC_C_COMPILER ) ) ) )
    ...
    if (  NOT ( JLN_FLAGS_OTHER_SANITIZERS STREQUAL "default") )
      if (  JLN_FLAGS_OTHER_SANITIZERS STREQUAL "thread" )
        ...
        if (  JLN_FLAGS_OTHER_SANITIZERS STREQUAL "memory" )
          if (  ( JLN_CLANG_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "5.0" ) ) )
      ...
      if (  NOT ( JLN_FLAGS_STACK_PROTECTOR STREQUAL "default") )
        if (  JLN_FLAGS_STACK_PROTECTOR STREQUAL "off" )
          ...
          if (  JLN_FLAGS_STACK_PROTECTOR STREQUAL "strong" )
            ...
            if (  ( JLN_MSVC_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "16.7" ) ) )
  ...
  if (  JLN_MSVC_C_COMPILER )
    ...
    if (  NOT ( JLN_FLAGS_MSVC_CONFORMANCE STREQUAL "default") )
      if (  ( JLN_FLAGS_MSVC_CONFORMANCE STREQUAL "all" OR JLN_FLAGS_MSVC_CONFORMANCE STREQUAL "all_without_throwing_new" ) )
        ...
        if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "15.6" ) )
          if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "16.8" ) )
            if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "16.5" ) )
    ...
    if (  NOT ( JLN_FLAGS_MSVC_ISYSTEM STREQUAL "default") )
      if (  JLN_FLAGS_MSVC_ISYSTEM STREQUAL "external_as_include_system_flag" )
        set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} /experimental:external /external:env:INCLUDE /external:W0 " CACHE INTERNAL "")
      ...
      if (  NOT ( JLN_FLAGS_WARNINGS STREQUAL "default") )
        if (  JLN_FLAGS_WARNINGS STREQUAL "off" )
          ...
          if (  NOT ( NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "19.21" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_SANITIZERS STREQUAL "default") )
      if (  NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "16.9" ) )
