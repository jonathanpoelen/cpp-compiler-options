...
set(_JLN_WARNINGS_COVERED_SWITCH_DEFAULT_VALUES default on off)
set(_JLN_WARNINGS_SWITCH_VALUES default on off enum mandatory_default)
...
set(JLN_WARNINGS_COVERED_SWITCH_DEFAULT "${JLN_WARNINGS_COVERED_SWITCH_DEFAULT}" CACHE STRING "")
set_property(CACHE JLN_WARNINGS_COVERED_SWITCH_DEFAULT PROPERTY STRINGS "default" "on" "off")
if(NOT("${JLN_WARNINGS_COVERED_SWITCH_DEFAULT}" STREQUAL ""))
  string(TOLOWER "${JLN_WARNINGS_COVERED_SWITCH_DEFAULT}" JLN_WARNINGS_COVERED_SWITCH_DEFAULT)
  if(NOT(("default" STREQUAL JLN_WARNINGS_COVERED_SWITCH_DEFAULT) OR ("on" STREQUAL JLN_WARNINGS_COVERED_SWITCH_DEFAULT) OR ("off" STREQUAL JLN_WARNINGS_COVERED_SWITCH_DEFAULT)))
    message(FATAL_ERROR "Unknow value \"${JLN_WARNINGS_COVERED_SWITCH_DEFAULT}\" for JLN_WARNINGS_COVERED_SWITCH_DEFAULT, expected: default, on, off")
  endif()
endif()
set(JLN_WARNINGS_SWITCH "${JLN_WARNINGS_SWITCH}" CACHE STRING "")
set_property(CACHE JLN_WARNINGS_SWITCH PROPERTY STRINGS "default" "on" "off" "enum" "mandatory_default")
if(NOT("${JLN_WARNINGS_SWITCH}" STREQUAL ""))
  string(TOLOWER "${JLN_WARNINGS_SWITCH}" JLN_WARNINGS_SWITCH)
  if(NOT(("default" STREQUAL JLN_WARNINGS_SWITCH) OR ("on" STREQUAL JLN_WARNINGS_SWITCH) OR ("off" STREQUAL JLN_WARNINGS_SWITCH) OR ("enum" STREQUAL JLN_WARNINGS_SWITCH) OR ("mandatory_default" STREQUAL JLN_WARNINGS_SWITCH)))
    message(FATAL_ERROR "Unknow value \"${JLN_WARNINGS_SWITCH}\" for JLN_WARNINGS_SWITCH, expected: default, on, off, enum, mandatory_default")
  endif()
endif()
...
function(jln_c_init_flags)
  jln_c_parse_arguments(JLN_DEFAULT_FLAG "VERBOSE;COLOR;CONTROL_FLOW;CONVERSION_WARNINGS;COVERAGE;CPU;DEBUG;DIAGNOSTICS_FORMAT;DIAGNOSTICS_SHOW_TEMPLATE_TREE;ELIDE_TYPE;EXCEPTIONS;FIX_COMPILER_ERROR;LINKER;LTO;MICROSOFT_ABI_COMPATIBILITY_WARNING;MSVC_ISYSTEM;MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL;OPTIMIZATION;PEDANTIC;PIE;RELRO;REPRODUCIBLE_BUILD_WARNINGS;RTTI;SANITIZERS;SANITIZERS_EXTRA;SHADOW_WARNINGS;STACK_PROTECTOR;STL_DEBUG;STL_FIX;SUGGESTIONS;WARNINGS;WARNINGS_AS_ERROR;WARNINGS_COVERED_SWITCH_DEFAULT;WARNINGS_SWITCH;WHOLE_PROGRAM;AUTO_PROFILE" ${ARGN})
  ...
  if(DEFINED JLN_DEFAULT_FLAG_WARNINGS_COVERED_SWITCH_DEFAULT)
    set(JLN_WARNINGS_COVERED_SWITCH_DEFAULT_D ${JLN_DEFAULT_FLAG_WARNINGS_COVERED_SWITCH_DEFAULT} CACHE STRING "private" FORCE)
  elseif("${JLN_WARNINGS_COVERED_SWITCH_DEFAULT}" STREQUAL "")
    set(JLN_WARNINGS_COVERED_SWITCH_DEFAULT_D "on" CACHE STRING "private" FORCE)
  else()
    set(JLN_WARNINGS_COVERED_SWITCH_DEFAULT_D "${JLN_WARNINGS_COVERED_SWITCH_DEFAULT}" CACHE STRING "private" FORCE)
  endif()

  if(DEFINED JLN_DEFAULT_FLAG_WARNINGS_SWITCH)
    set(JLN_WARNINGS_SWITCH_D ${JLN_DEFAULT_FLAG_WARNINGS_SWITCH} CACHE STRING "private" FORCE)
  elseif("${JLN_WARNINGS_SWITCH}" STREQUAL "")
    set(JLN_WARNINGS_SWITCH_D "on" CACHE STRING "private" FORCE)
  else()
    set(JLN_WARNINGS_SWITCH_D "${JLN_WARNINGS_SWITCH}" CACHE STRING "private" FORCE)
  endif()
  ...
  if("${JLN_VERBOSE_D}" STREQUAL "on" OR "${JLN_VERBOSE_D}" STREQUAL "1")
    ...
    message(STATUS "JLN_WARNINGS_COVERED_SWITCH_DEFAULT = ${JLN_WARNINGS_COVERED_SWITCH_DEFAULT_D}	[default, on, off]")
    message(STATUS "JLN_WARNINGS_SWITCH = ${JLN_WARNINGS_SWITCH_D}	[default, on, off, enum, mandatory_default]")
...
function(jln_c_flags)
  ...
  set(CXX_FLAGS "")
  set(LINK_LINK "")
  jln_c_parse_arguments(JLN_FLAGS "DISABLE_OTHERS;C_VAR;LINK_VAR;COLOR;CONTROL_FLOW;CONVERSION_WARNINGS;COVERAGE;CPU;DEBUG;DIAGNOSTICS_FORMAT;DIAGNOSTICS_SHOW_TEMPLATE_TREE;ELIDE_TYPE;EXCEPTIONS;FIX_COMPILER_ERROR;LINKER;LTO;MICROSOFT_ABI_COMPATIBILITY_WARNING;MSVC_ISYSTEM;MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL;OPTIMIZATION;PEDANTIC;PIE;RELRO;REPRODUCIBLE_BUILD_WARNINGS;RTTI;SANITIZERS;SANITIZERS_EXTRA;SHADOW_WARNINGS;STACK_PROTECTOR;STL_DEBUG;STL_FIX;SUGGESTIONS;WARNINGS;WARNINGS_AS_ERROR;WARNINGS_COVERED_SWITCH_DEFAULT;WARNINGS_SWITCH;WHOLE_PROGRAM" ${ARGN})
  ...
  if(NOT DEFINED JLN_FLAGS_WARNINGS_COVERED_SWITCH_DEFAULT)
    if(JLN_FLAGS_DISABLE_OTHERS)
      set(JLN_FLAGS_WARNINGS_COVERED_SWITCH_DEFAULT "on")
    else()
      set(JLN_FLAGS_WARNINGS_COVERED_SWITCH_DEFAULT "${JLN_WARNINGS_COVERED_SWITCH_DEFAULT_D}")
    endif()
  endif()

  if(NOT DEFINED JLN_FLAGS_WARNINGS_SWITCH)
    if(JLN_FLAGS_DISABLE_OTHERS)
      set(JLN_FLAGS_WARNINGS_SWITCH "on")
    else()
      set(JLN_FLAGS_WARNINGS_SWITCH "${JLN_WARNINGS_SWITCH_D}")
    endif()
  endif()
    ...
    if (  NOT ( JLN_FLAGS_WARNINGS STREQUAL "default") )
      if (  JLN_FLAGS_WARNINGS STREQUAL "off" )
        ...
        if (  JLN_GCC_C_COMPILER )
          ...
          if (  NOT ( JLN_FLAGS_WARNINGS_SWITCH STREQUAL "default") )
            if (  JLN_FLAGS_WARNINGS_SWITCH STREQUAL "on" )
              list(APPEND CXX_FLAGS  "-Wswitch")
            else()
              if (  JLN_FLAGS_WARNINGS_SWITCH STREQUAL "enum" )
                list(APPEND CXX_FLAGS  "-Wswitch-enum")
              else()
                if (  JLN_FLAGS_WARNINGS_SWITCH STREQUAL "mandatory_default" )
          ...
          if (  ( JLN_CLANG_C_COMPILER OR JLN_CLANG_CL_C_COMPILER ) )
            ...
            if (  NOT ( JLN_FLAGS_WARNINGS_SWITCH STREQUAL "default") )
              if (  JLN_FLAGS_WARNINGS_SWITCH STREQUAL "on" )
                ...
                if (  JLN_FLAGS_WARNINGS_SWITCH STREQUAL "enum" )
                  ...
                  if (  JLN_FLAGS_WARNINGS_SWITCH STREQUAL "off" )
            ...
            if (  NOT ( JLN_FLAGS_WARNINGS_COVERED_SWITCH_DEFAULT STREQUAL "default") )
              if (  JLN_FLAGS_WARNINGS_COVERED_SWITCH_DEFAULT STREQUAL "off" )
