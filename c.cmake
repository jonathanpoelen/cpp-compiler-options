...
function(jln_c_flags)
  ...
  if (  ( JLN_GCC_C_COMPILER OR JLN_CLANG_C_COMPILER OR JLN_CLANG_CL_C_COMPILER OR JLN_ICX_C_COMPILER ) )
    if (  NOT ( JLN_FLAGS_WARNINGS STREQUAL "default") )
      if (  JLN_FLAGS_WARNINGS STREQUAL "off" )
        ...
        if (  JLN_GCC_C_COMPILER )
          ...
          if (  ( JLN_CLANG_C_COMPILER OR JLN_CLANG_CL_C_COMPILER OR JLN_ICX_C_COMPILER ) )
    ...
    if (  NOT ( JLN_FLAGS_CONTROL_FLOW STREQUAL "default") )
      if (  JLN_FLAGS_CONTROL_FLOW STREQUAL "off" )
        ...
        if (  ( ( JLN_GCC_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "8.0" ) ) OR JLN_CLANG_CL_C_COMPILER ) )
    ...
    if (  NOT ( JLN_FLAGS_COLOR STREQUAL "default") )
      if (  ( ( JLN_GCC_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "4.9" ) ) OR JLN_CLANG_C_COMPILER OR JLN_CLANG_CL_C_COMPILER OR JLN_ICX_C_COMPILER ) )
    ...
    if (  NOT ( JLN_FLAGS_DIAGNOSTICS_FORMAT STREQUAL "default") )
      if (  JLN_FLAGS_DIAGNOSTICS_FORMAT STREQUAL "fixits" )
        if (  ( ( JLN_GCC_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "7.0" ) ) OR ( JLN_CLANG_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "5.0" ) ) OR ( JLN_CLANG_CL_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "5.0" ) ) OR ( JLN_ICX_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "5.0" ) ) ) )
  ...
  if (  ( JLN_GCC_C_COMPILER OR JLN_CLANG_C_COMPILER OR JLN_CLANG_CL_C_COMPILER OR JLN_ICX_C_COMPILER OR JLN_ICC_C_COMPILER ) )
  ...
  if (  ( JLN_GCC_C_COMPILER OR JLN_CLANG_C_COMPILER ) )
    ...
    if (  NOT ( JLN_FLAGS_LTO STREQUAL "default") )
      if (  JLN_FLAGS_LTO STREQUAL "off" )
        ...
        if (  JLN_GCC_C_COMPILER )
          ...
          if (  ( JLN_FLAGS_LTO STREQUAL "thin" AND JLN_CLANG_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "6.0" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_SHADOW_WARNINGS STREQUAL "default") )
      if (  JLN_FLAGS_SHADOW_WARNINGS STREQUAL "off" )
        ...
        if (  ( JLN_CLANG_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "8.0" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_FLOAT_SANITIZERS STREQUAL "default") )
      if (  ( ( JLN_GCC_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "5.0" ) ) OR ( JLN_CLANG_C_COMPILER AND NOT ( JLN_C_COMPILER_VERSION VERSION_LESS "5.0" ) ) ) )
  ...
  if (  ( JLN_MSVC_C_COMPILER OR JLN_CLANG_CL_C_COMPILER OR JLN_ICL_C_COMPILER ) )
    ...
    if (  ( JLN_MSVC_C_COMPILER OR JLN_CLANG_CL_C_COMPILER ) )
