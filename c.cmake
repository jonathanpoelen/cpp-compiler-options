...
# init default values
# jln_c_init_flags([<jln_c-option> <default_value>]... [AUTO_PROFILE on] [VERBOSE on])
# AUTO_PROFILE: enables options based on CMAKE_BUILD_TYPE (assumes "Debug" if CMAKE_BUILD_TYPE is empty)
function(jln_c_init_flags)
  cmake_parse_arguments(JLN_DEFAULT_FLAG "" "VERBOSE;COLOR;CONTROL_FLOW;COVERAGE;CPU;DEBUG;DIAGNOSTICS_FORMAT;DIAGNOSTICS_SHOW_TEMPLATE_TREE;ELIDE_TYPE;EXCEPTIONS;FIX_COMPILER_ERROR;LINKER;LTO;MSVC_ISYSTEM;MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL;OPTIMIZATION;PEDANTIC;PIE;RELRO;REPRODUCIBLE_BUILD_WARNINGS;RTTI;SANITIZERS;SANITIZERS_EXTRA;SHADOW_WARNINGS;STACK_PROTECTOR;STL_DEBUG;STL_FIX;SUGGESTIONS;WARNINGS;WARNINGS_AS_ERROR;WHOLE_PROGRAM;AUTO_PROFILE" "" ${ARGN})
  ...
  if(DEFINED JLN_DEFAULT_FLAG_CONTROL_FLOW)
    ...
    if(NOT(("default" STREQUAL JLN_DEFAULT_FLAG_CONTROL_FLOW) OR ("off" STREQUAL JLN_DEFAULT_FLAG_CONTROL_FLOW) OR ("on" STREQUAL JLN_DEFAULT_FLAG_CONTROL_FLOW) OR ("branch" STREQUAL JLN_DEFAULT_FLAG_CONTROL_FLOW) OR ("return" STREQUAL JLN_DEFAULT_FLAG_CONTROL_FLOW) OR ("allow_bugs" STREQUAL JLN_DEFAULT_FLAG_CONTROL_FLOW)))
      message(FATAL_ERROR "Unknow value \"${JLN_DEFAULT_FLAG_CONTROL_FLOW}\" for CONTROL_FLOW, expected: default, off, on, branch, return, allow_bugs")
    endif()
  ...
  if(DEFINED JLN_DEFAULT_FLAG_LINKER)
    ...
    if(NOT(("default" STREQUAL JLN_DEFAULT_FLAG_LINKER) OR ("bfd" STREQUAL JLN_DEFAULT_FLAG_LINKER) OR ("gold" STREQUAL JLN_DEFAULT_FLAG_LINKER) OR ("lld" STREQUAL JLN_DEFAULT_FLAG_LINKER) OR ("native" STREQUAL JLN_DEFAULT_FLAG_LINKER)))
      message(FATAL_ERROR "Unknow value \"${JLN_DEFAULT_FLAG_LINKER}\" for LINKER, expected: default, bfd, gold, lld, native")
    endif()
  ...
  if(DEFINED JLN_DEFAULT_FLAG_LTO)
    ...
    if(NOT(("default" STREQUAL JLN_DEFAULT_FLAG_LTO) OR ("off" STREQUAL JLN_DEFAULT_FLAG_LTO) OR ("on" STREQUAL JLN_DEFAULT_FLAG_LTO) OR ("fat" STREQUAL JLN_DEFAULT_FLAG_LTO) OR ("thin" STREQUAL JLN_DEFAULT_FLAG_LTO)))
      message(FATAL_ERROR "Unknow value \"${JLN_DEFAULT_FLAG_LTO}\" for LTO, expected: default, off, on, fat, thin")
    endif()
  ...
  if(DEFINED JLN_DEFAULT_FLAG_MSVC_ISYSTEM)
    string(TOLOWER "${JLN_DEFAULT_FLAG_MSVC_ISYSTEM}" JLN_DEFAULT_FLAG_MSVC_ISYSTEM)
    if(NOT(("default" STREQUAL JLN_DEFAULT_FLAG_MSVC_ISYSTEM) OR ("anglebrackets" STREQUAL JLN_DEFAULT_FLAG_MSVC_ISYSTEM) OR ("INCLUDE_and_CAExcludePath" STREQUAL JLN_DEFAULT_FLAG_MSVC_ISYSTEM)))
      message(FATAL_ERROR "Unknow value \"${JLN_DEFAULT_FLAG_MSVC_ISYSTEM}\" for MSVC_ISYSTEM, expected: default, anglebrackets, INCLUDE_and_CAExcludePath")
    endif()
  ...
  if(DEFINED JLN_DEFAULT_FLAG_MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL)
    string(TOLOWER "${JLN_DEFAULT_FLAG_MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL}" JLN_DEFAULT_FLAG_MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL)
    if(NOT(("default" STREQUAL JLN_DEFAULT_FLAG_MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL) OR ("off" STREQUAL JLN_DEFAULT_FLAG_MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL) OR ("on" STREQUAL JLN_DEFAULT_FLAG_MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL)))
      message(FATAL_ERROR "Unknow value \"${JLN_DEFAULT_FLAG_MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL}\" for MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL, expected: default, off, on")
    endif()
...
# jln_c_target_interface(<libname> {INTERFACE|PUBLIC|PRIVATE} [<jln_c-option> <value>]... [DISABLE_OTHERS on|off])
function(jln_c_target_interface name type)
  jln_c_flags(C_VAR cxx LINK_VAR link ${ARGV})
  add_library(${name} ${type})
  target_link_libraries(${name} ${type} ${link})
  target_compile_options(${name} ${type} ${cxx})
endfunction()

# jln_c_flags(C_VAR <out-variable> LINK_VAR <out-variable> [<jln_c-option> <value>]... [DISABLE_OTHERS on|off])
function(jln_c_flags)
  ...
  set(CXX_FLAGS "")
  set(LINK_LINK "")
  cmake_parse_arguments(JLN_FLAGS "DISABLE_OTHERS" "C_VAR;LINK_VAR;COLOR;CONTROL_FLOW;COVERAGE;CPU;DEBUG;DIAGNOSTICS_FORMAT;DIAGNOSTICS_SHOW_TEMPLATE_TREE;ELIDE_TYPE;EXCEPTIONS;FIX_COMPILER_ERROR;LINKER;LTO;MSVC_ISYSTEM;MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL;OPTIMIZATION;PEDANTIC;PIE;RELRO;REPRODUCIBLE_BUILD_WARNINGS;RTTI;SANITIZERS;SANITIZERS_EXTRA;SHADOW_WARNINGS;STACK_PROTECTOR;STL_DEBUG;STL_FIX;SUGGESTIONS;WARNINGS;WARNINGS_AS_ERROR;WHOLE_PROGRAM" "" ${ARGN})
  ...
  if(DEFINED JLN_FLAGS_CONTROL_FLOW)
    ...
    if(NOT(("default" STREQUAL JLN_FLAGS_CONTROL_FLOW) OR ("off" STREQUAL JLN_FLAGS_CONTROL_FLOW) OR ("on" STREQUAL JLN_FLAGS_CONTROL_FLOW) OR ("branch" STREQUAL JLN_FLAGS_CONTROL_FLOW) OR ("return" STREQUAL JLN_FLAGS_CONTROL_FLOW) OR ("allow_bugs" STREQUAL JLN_FLAGS_CONTROL_FLOW)))
      message(FATAL_ERROR "Unknow value \"${JLN_FLAGS_CONTROL_FLOW}\" for CONTROL_FLOW, expected: default, off, on, branch, return, allow_bugs")
    endif()
  else()
    if(JLN_FLAGS_DISABLE_OTHERS)
  ...
  if(DEFINED JLN_FLAGS_LINKER)
    ...
    if(NOT(("default" STREQUAL JLN_FLAGS_LINKER) OR ("bfd" STREQUAL JLN_FLAGS_LINKER) OR ("gold" STREQUAL JLN_FLAGS_LINKER) OR ("lld" STREQUAL JLN_FLAGS_LINKER) OR ("native" STREQUAL JLN_FLAGS_LINKER)))
      message(FATAL_ERROR "Unknow value \"${JLN_FLAGS_LINKER}\" for LINKER, expected: default, bfd, gold, lld, native")
    endif()
  else()
    if(JLN_FLAGS_DISABLE_OTHERS)
  ...
  if(DEFINED JLN_FLAGS_LTO)
    ...
    if(NOT(("default" STREQUAL JLN_FLAGS_LTO) OR ("off" STREQUAL JLN_FLAGS_LTO) OR ("on" STREQUAL JLN_FLAGS_LTO) OR ("fat" STREQUAL JLN_FLAGS_LTO) OR ("thin" STREQUAL JLN_FLAGS_LTO)))
      message(FATAL_ERROR "Unknow value \"${JLN_FLAGS_LTO}\" for LTO, expected: default, off, on, fat, thin")
    endif()
  else()
    if(JLN_FLAGS_DISABLE_OTHERS)
  ...
  if(DEFINED JLN_FLAGS_MSVC_ISYSTEM)
    string(TOLOWER "${JLN_FLAGS_MSVC_ISYSTEM}" JLN_FLAGS_MSVC_ISYSTEM)
    if(NOT(("default" STREQUAL JLN_FLAGS_MSVC_ISYSTEM) OR ("anglebrackets" STREQUAL JLN_FLAGS_MSVC_ISYSTEM) OR ("INCLUDE_and_CAExcludePath" STREQUAL JLN_FLAGS_MSVC_ISYSTEM)))
      message(FATAL_ERROR "Unknow value \"${JLN_FLAGS_MSVC_ISYSTEM}\" for MSVC_ISYSTEM, expected: default, anglebrackets, INCLUDE_and_CAExcludePath")
    endif()
  else()
    if(JLN_FLAGS_DISABLE_OTHERS)
  ...
  if(DEFINED JLN_FLAGS_MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL)
    string(TOLOWER "${JLN_FLAGS_MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL}" JLN_FLAGS_MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL)
    if(NOT(("default" STREQUAL JLN_FLAGS_MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL) OR ("off" STREQUAL JLN_FLAGS_MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL) OR ("on" STREQUAL JLN_FLAGS_MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL)))
      message(FATAL_ERROR "Unknow value \"${JLN_FLAGS_MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL}\" for MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL, expected: default, off, on")
    endif()
  else()
    if(JLN_FLAGS_DISABLE_OTHERS)
      ...
      if (  JLN_FLAGS_WARNINGS STREQUAL "off" )
        ...
        if (  JLN_GCC_C_COMPILER )
          ...
          if (  ( JLN_CLANG_C_COMPILER OR JLN_CLANG_CL_C_COMPILER ) )
            list(APPEND CXX_FLAGS  "-Weverything" "-Wno-documentation" "-Wno-documentation-unknown-command" "-Wno-newline-eof" "-Wno-mismatched-tags" "-Wno-padded" "-Wno-global-constructors" "-Wno-covered-switch-default" "-Wno-switch-default" "-Wno-switch-enum")
    ...
    if (  NOT ( JLN_FLAGS_WARNINGS_AS_ERROR STREQUAL "default") )
      if (  JLN_FLAGS_WARNINGS_AS_ERROR STREQUAL "on" )
        ...
        if (  JLN_FLAGS_WARNINGS_AS_ERROR STREQUAL "basic" )
          ...
          if (  ( JLN_GCC_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "5.1" ) ) )
  ...
  if (  ( JLN_GCC_C_COMPILER OR JLN_CLANG_C_COMPILER ) )
    ...
    if (  NOT ( JLN_FLAGS_ELIDE_TYPE STREQUAL "default") )
      if (  JLN_FLAGS_ELIDE_TYPE STREQUAL "on" )
        ...
        if (  ( ( JLN_GCC_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "8.0" ) ) OR ( JLN_CLANG_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "3.4" ) ) ) )
        endif()
      endif()
    endif()
    ...
    if (  NOT ( JLN_FLAGS_DIAGNOSTICS_SHOW_TEMPLATE_TREE STREQUAL "default") )
      if (  ( ( JLN_GCC_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "8.0" ) ) OR JLN_CLANG_C_COMPILER ) )
    ...
    if (  NOT ( JLN_FLAGS_MSVC_ISYSTEM STREQUAL "default") )
      ...
      if (  NOT ( JLN_FLAGS_WARNINGS STREQUAL "default") )
        if (  JLN_FLAGS_WARNINGS STREQUAL "off" )
          ...
          list(APPEND CXX_FLAGS  "/wd4710" "/wd4711" "/wd4774")
      ...
      if (  NOT ( JLN_FLAGS_WARNINGS STREQUAL "default") )
        if (  JLN_FLAGS_WARNINGS STREQUAL "off" )
          ...
          if (  JLN_FLAGS_WARNINGS STREQUAL "on" )
            ...
            list(APPEND CXX_FLAGS  "/Wall" "/wd4355" "/wd4365" "/wd4514" "/wd4548" "/wd4571" "/wd4577" "/wd4625" "/wd4626" "/wd4668" "/wd4710" "/wd4711" "/wd4774" "/wd4820" "/wd5026" "/wd5027" "/wd5039" "/wd4464" "/wd4868" "/wd5045")
            if (  JLN_FLAGS_WARNINGS STREQUAL "strict" )
