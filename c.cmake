...
set(_JLN_SWITCH_WARNINGS_VALUES default on off exhaustive_enum mandatory_default)
...
set_property(CACHE JLN_SWITCH_WARNINGS PROPERTY STRINGS "default" "on" "off" "exhaustive_enum" "mandatory_default")
if(NOT("${JLN_SWITCH_WARNINGS}" STREQUAL ""))
  string(TOLOWER "${JLN_SWITCH_WARNINGS}" JLN_SWITCH_WARNINGS)
  if(NOT(("default" STREQUAL JLN_SWITCH_WARNINGS) OR ("on" STREQUAL JLN_SWITCH_WARNINGS) OR ("off" STREQUAL JLN_SWITCH_WARNINGS) OR ("exhaustive_enum" STREQUAL JLN_SWITCH_WARNINGS) OR ("mandatory_default" STREQUAL JLN_SWITCH_WARNINGS)))
    message(FATAL_ERROR "Unknow value \"${JLN_SWITCH_WARNINGS}\" for JLN_SWITCH_WARNINGS, expected: default, on, off, exhaustive_enum, mandatory_default")
  endif()
endif()
...
function(jln_c_init_flags)
  ...
  if("${JLN_VERBOSE_D}" STREQUAL "on" OR "${JLN_VERBOSE_D}" STREQUAL "1")
    ...
    message(STATUS "JLN_SWITCH_WARNINGS = ${JLN_SWITCH_WARNINGS_D}	[default, on, off, exhaustive_enum, mandatory_default]")
...
function(jln_c_flags)
  ...
  set(CXX_FLAGS "")
  set(LINK_LINK "")
  jln_c_parse_arguments(JLN_FLAGS "DISABLE_OTHERS;C_VAR;LINK_VAR;COLOR;CONTROL_FLOW;CONVERSION_WARNINGS;COVERAGE;COVERED_SWITCH_DEFAULT_WARNINGS;CPU;DEBUG;DIAGNOSTICS_FORMAT;DIAGNOSTICS_SHOW_TEMPLATE_TREE;ELIDE_TYPE;EXCEPTIONS;FIX_COMPILER_ERROR;FLOAT_SANITIZERS;INTEGER_SANITIZERS;LINKER;LTO;MICROSOFT_ABI_COMPATIBILITY_WARNINGS;MSVC_ISYSTEM;MSVC_ISYSTEM_WITH_TEMPLATE_FROM_NON_EXTERNAL;NOEXCEPT_WARNINGS;OPTIMIZATION;OTHER_SANITIZERS;PEDANTIC;PIE;RELRO;REPRODUCIBLE_BUILD_WARNINGS;RTTI;SANITIZERS;SHADOW_WARNINGS;STACK_PROTECTOR;STL_DEBUG;STL_FIX;SUGGESTIONS;SWITCH_WARNINGS;WARNINGS;WARNINGS_AS_ERROR;WHOLE_PROGRAM" ${ARGN})
  ...
  if (  ( JLN_GCC_C_COMPILER OR JLN_CLANG_C_COMPILER OR JLN_CLANG_CL_C_COMPILER ) )
    if (  NOT ( JLN_FLAGS_WARNINGS STREQUAL "default") )
      if (  JLN_FLAGS_WARNINGS STREQUAL "off" )
        ...
        if (  JLN_GCC_C_COMPILER )
            list(APPEND CXX_FLAGS  "-Wall" "-Wextra" "-Wcast-align" "-Wcast-qual" "-Wdisabled-optimization" "-Wfloat-equal" "-Wformat-security" "-Wformat=2" "-Wmissing-include-dirs" "-Wpacked" "-Wredundant-decls" "-Wundef" "-Wunused-macros" "-Winvalid-pch" "-Wpointer-arith" "-Wbad-function-cast" "-Winit-self" "-Wjump-misses-init" "-Wnested-externs" "-Wold-style-definition" "-Wstrict-prototypes" "-Wwrite-strings")
        ...
        if (  ( JLN_FLAGS_WARNINGS STREQUAL "strict" OR JLN_FLAGS_WARNINGS STREQUAL "very_strict" ) )
          if (  ( JLN_GCC_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "8.0" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_CONTROL_FLOW STREQUAL "default") )
      if (  JLN_FLAGS_CONTROL_FLOW STREQUAL "off" )
        ...
        if (  ( ( JLN_GCC_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "8.0" ) ) OR JLN_CLANG_CL_C_COMPILER ) )
    ...
    if (  NOT ( JLN_FLAGS_COLOR STREQUAL "default") )
      if (  ( ( JLN_GCC_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "4.9" ) ) OR JLN_CLANG_C_COMPILER OR JLN_CLANG_CL_C_COMPILER ) )
    ...
    if (  NOT ( JLN_FLAGS_REPRODUCIBLE_BUILD_WARNINGS STREQUAL "default") )
      if (  ( JLN_GCC_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "4.9" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_DIAGNOSTICS_FORMAT STREQUAL "default") )
      if (  JLN_FLAGS_DIAGNOSTICS_FORMAT STREQUAL "fixits" )
        if (  ( ( JLN_GCC_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "7.0" ) ) OR ( JLN_CLANG_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "5.0" ) ) OR ( JLN_CLANG_CL_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "5.0" ) ) ) )
          list(APPEND CXX_FLAGS  "-fdiagnostics-parseable-fixits")
        endif()
      else()
        if (  JLN_FLAGS_DIAGNOSTICS_FORMAT STREQUAL "patch" )
          if (  ( JLN_GCC_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "7.0" ) ) )
  ...
  if (  ( JLN_GCC_C_COMPILER OR JLN_CLANG_C_COMPILER ) )
    ...
    if (  NOT ( JLN_FLAGS_LINKER STREQUAL "default") )
      if (  JLN_FLAGS_LINKER STREQUAL "native" )
        ...
        if (  JLN_FLAGS_LINKER STREQUAL "bfd" )
          ...
          if (  ( JLN_FLAGS_LINKER STREQUAL "gold" OR ( JLN_GCC_C_COMPILER AND NOT ( NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "9.0" ) ) ) ) )
            list(APPEND LINK_FLAGS  "-fuse-ld=gold")
          else()
    ...
    if (  NOT ( JLN_FLAGS_LTO STREQUAL "default") )
      if (  JLN_FLAGS_LTO STREQUAL "off" )
        ...
        if (  JLN_GCC_C_COMPILER )
          ...
          if (  ( JLN_FLAGS_LTO STREQUAL "thin" AND JLN_CLANG_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "6.0" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_WHOLE_PROGRAM STREQUAL "default") )
      if (  JLN_FLAGS_WHOLE_PROGRAM STREQUAL "off" )
        ...
        if (  ( JLN_CLANG_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "3.9" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_SHADOW_WARNINGS STREQUAL "default") )
      if (  JLN_FLAGS_SHADOW_WARNINGS STREQUAL "off" )
        ...
        if (  ( JLN_CLANG_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "8.0" ) ) )
        ...
        if (  JLN_FLAGS_SHADOW_WARNINGS STREQUAL "on" )
          ...
          if (  JLN_FLAGS_SHADOW_WARNINGS STREQUAL "all" )
            ...
            if (  ( JLN_GCC_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "7.1" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_OTHER_SANITIZERS STREQUAL "default") )
      if (  JLN_FLAGS_OTHER_SANITIZERS STREQUAL "thread" )
        ...
        if (  JLN_FLAGS_OTHER_SANITIZERS STREQUAL "memory" )
          if (  ( JLN_CLANG_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "5.0" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_FLOAT_SANITIZERS STREQUAL "default") )
      if (  ( ( JLN_GCC_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "5.0" ) ) OR ( JLN_CLANG_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "5.0" ) ) ) )
    ...
    if (  NOT ( JLN_FLAGS_STACK_PROTECTOR STREQUAL "default") )
      if (  JLN_FLAGS_STACK_PROTECTOR STREQUAL "off" )
        ...
        if (  JLN_FLAGS_STACK_PROTECTOR STREQUAL "strong" )
          ...
          if (  ( JLN_MSVC_C_COMPILER AND NOT ( CMAKE_CXX_COMPILER_VERSION VERSION_LESS "16.7" ) ) )
