...
function(jln_c_init_flags)
  jln_c_parse_arguments(JLN_DEFAULT_FLAG "VERBOSE;ANALYZER;ANALYZER_TOO_COMPLEX_WARNING;ANALYZER_VERBOSITY;COLOR;CONTROL_FLOW;CONVERSION_WARNINGS;COVERAGE;COVERED_SWITCH_DEFAULT_WARNINGS;CPU;DIAGNOSTICS_FORMAT;EXCEPTIONS;LINKER;LTO;MSVC_CRT_SECURE_NO_WARNINGS;MSVC_DIAGNOSTICS_FORMAT;MSVC_ISYSTEM;NDEBUG;OPTIMIZATION;PEDANTIC;PIE;RELRO;REPRODUCIBLE_BUILD_WARNINGS;SANITIZERS;SHADOW_WARNINGS;STACK_PROTECTOR;STL_FIX;SUGGEST_ATTRIBUTES;SWITCH_WARNINGS;SYMBOLS;UNSAFE_BUFFER_USAGE_WARNINGS;VAR_INIT;WARNINGS;WARNINGS_AS_ERROR;WINDOWS_BIGOBJ;AUTO_PROFILE" ${ARGN})
        ...
        if (  JLN_FLAGS_CONTROL_FLOW STREQUAL "off" )
          ...
          if (  ( ( JLN_GCC_C_COMPILER AND JLN_C_COMPILER_VERSION VERSION_GREATER_EQUAL "8.0" ) OR  NOT ( JLN_GCC_C_COMPILER ) ) )
            ...
            if (  ( JLN_FLAGS_CONTROL_FLOW STREQUAL "allow_bugs" AND JLN_CLANG_C_COMPILER ) )
              ...
              if (   NOT ( JLN_CLANG_CL_C_COMPILER ) )
    ...
    if (   NOT ( JLN_ICL_C_COMPILER ) )
      ...
      if (   NOT ( JLN_FLAGS_STACK_PROTECTOR STREQUAL "default" ) )
        if (  JLN_FLAGS_STACK_PROTECTOR STREQUAL "off" )
          ...
          if (  JLN_FLAGS_STACK_PROTECTOR STREQUAL "strong" )
            if (  ( JLN_MSVC_C_COMPILER AND JLN_C_COMPILER_VERSION VERSION_GREATER_EQUAL "19.27" ) )
