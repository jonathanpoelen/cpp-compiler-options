...
function(jln_c_flags)
  ...
  if (  ( JLN_GCC_C_COMPILER OR JLN_CLANG_LIKE_COMPILER ) )
    if (   NOT ( JLN_FLAGS_WARNINGS STREQUAL "default" ) )
      if (  JLN_FLAGS_WARNINGS STREQUAL "off" )
        ...
        if (  JLN_GCC_C_COMPILER )
          list(APPEND CXX_FLAGS  "-Wall" "-Wextra" "-Wcast-align" "-Wcast-qual" "-Wdisabled-optimization" "-Wfloat-equal" "-Wformat-security" "-Wformat=2" "-Winvalid-pch" "-Wmissing-include-dirs" "-Wpacked" "-Wredundant-decls" "-Wundef" "-Wunused-macros" "-Wpointer-arith" "-Wbad-function-cast" "-Winit-self" "-Wjump-misses-init" "-Wnested-externs" "-Wold-style-definition" "-Wstrict-prototypes" "-Wwrite-strings")
    ...
    if (   NOT ( JLN_FLAGS_UNSAFE_BUFFER_USAGE_WARNINGS STREQUAL "default" ) )
      if (  ( JLN_CLANG_LIKE_COMPILER AND JLN_C_COMPILER_VERSION VERSION_GREATER_EQUAL "16.0" ) )
    ...
    if (   NOT ( JLN_FLAGS_SANITIZERS STREQUAL "default" ) )
      if (  JLN_FLAGS_SANITIZERS STREQUAL "off" )
        ...
        if (  JLN_CLANG_CL_C_COMPILER )
          ...
          if (  ( JLN_CLANG_C_COMPILER OR JLN_CLANG_EMCC_C_COMPILER ) )
            if (  JLN_C_COMPILER_VERSION VERSION_GREATER_EQUAL "3.1" )
              ...
              if (  JLN_CLANG_C_COMPILER )
                ...
                if (  JLN_C_COMPILER_VERSION VERSION_GREATER_EQUAL "6.0" )
    ...
    if (   NOT ( JLN_FLAGS_CONTROL_FLOW STREQUAL "default" ) )
      if (  JLN_CLANG_EMCC_C_COMPILER )
        ...
        if (  JLN_FLAGS_CONTROL_FLOW STREQUAL "off" )
          if (  ( JLN_GCC_C_COMPILER AND JLN_C_COMPILER_VERSION VERSION_GREATER_EQUAL "8.0" ) )
          ...
          if (  ( ( JLN_GCC_C_COMPILER AND JLN_C_COMPILER_VERSION VERSION_GREATER_EQUAL "8.0" ) OR  NOT ( JLN_GCC_C_COMPILER ) ) )
            ...
            if (  ( JLN_FLAGS_CONTROL_FLOW STREQUAL "allow_bugs" AND JLN_CLANG_C_COMPILER ) )
    ...
    if (   NOT ( JLN_FLAGS_LTO STREQUAL "default" ) )
      if (  JLN_FLAGS_LTO STREQUAL "off" )
        ...
        if (  JLN_GCC_C_COMPILER )
          ...
          if (  ( ( JLN_FLAGS_LTO STREQUAL "thin" OR JLN_FLAGS_LTO STREQUAL "on" ) AND JLN_C_COMPILER_VERSION VERSION_GREATER_EQUAL "6.0" ) )
    ...
    if (   NOT ( JLN_FLAGS_SHADOW_WARNINGS STREQUAL "default" ) )
      if (  JLN_FLAGS_SHADOW_WARNINGS STREQUAL "off" )
        ...
        if (  ( JLN_CLANG_LIKE_COMPILER AND JLN_C_COMPILER_VERSION VERSION_GREATER_EQUAL "8.0" ) )
    ...
    if (   NOT ( JLN_FLAGS_FLOAT_SANITIZERS STREQUAL "default" ) )
      if (  ( ( JLN_GCC_C_COMPILER AND JLN_C_COMPILER_VERSION VERSION_GREATER_EQUAL "5.0" ) OR ( JLN_CLANG_LIKE_COMPILER AND JLN_C_COMPILER_VERSION VERSION_GREATER_EQUAL "5.0" ) ) )
    ...
    if (   NOT ( JLN_FLAGS_INTEGER_SANITIZERS STREQUAL "default" ) )
      if (  ( JLN_CLANG_LIKE_COMPILER AND JLN_C_COMPILER_VERSION VERSION_GREATER_EQUAL "5.0" ) )
  ...
  if (   NOT ( JLN_FLAGS_CONVERSION_WARNINGS STREQUAL "default" ) )
    if (  ( JLN_GCC_C_COMPILER OR JLN_CLANG_LIKE_COMPILER OR JLN_ICC_C_COMPILER ) )
  ...
  if (  ( JLN_GCC_C_COMPILER OR JLN_CLANG_C_COMPILER OR JLN_CLANG_EMCC_C_COMPILER ) )
    ...
    if (  JLN_CLANG_EMCC_C_COMPILER )
          ...
          if (  JLN_FLAGS_LINKER STREQUAL "native" )
            ...
            if (  JLN_FLAGS_LINKER STREQUAL "bfd" )
              ...
              if (  ( JLN_FLAGS_LINKER STREQUAL "gold" OR ( JLN_GCC_C_COMPILER AND JLN_C_COMPILER_VERSION VERSION_LESS "9.0" ) ) )
                ...
                if (   NOT ( JLN_FLAGS_LTO STREQUAL "default" ) )
                  if (  (  NOT ( JLN_FLAGS_LTO STREQUAL "off" ) AND JLN_GCC_C_COMPILER ) )
                    list(APPEND LINK_FLAGS  "-fuse-ld=gold")
                  else()
                    list(APPEND LINK_FLAGS  "-fuse-ld=lld")
                  endif()
      ...
      if (   NOT ( JLN_FLAGS_WHOLE_PROGRAM STREQUAL "default" ) )
        if (  JLN_FLAGS_WHOLE_PROGRAM STREQUAL "off" )
          ...
          if (  ( JLN_CLANG_C_COMPILER AND JLN_C_COMPILER_VERSION VERSION_GREATER_EQUAL "3.9" ) )
      ...
      if (   NOT ( JLN_FLAGS_RELRO STREQUAL "default" ) )
        if (  JLN_FLAGS_RELRO STREQUAL "off" )
          ...
          if (  JLN_FLAGS_RELRO STREQUAL "on" )
            ...
            if (   NOT ( JLN_FLAGS_LINKER STREQUAL "default" ) )
              if (  NOT ( ( JLN_FLAGS_LINKER STREQUAL "gold" OR ( JLN_GCC_C_COMPILER AND JLN_C_COMPILER_VERSION VERSION_LESS "9.0" ) OR ( JLN_FLAGS_LINKER STREQUAL "native" AND JLN_GCC_C_COMPILER ) ) ) )
      ...
      if (   NOT ( JLN_FLAGS_OTHER_SANITIZERS STREQUAL "default" ) )
        if (  JLN_FLAGS_OTHER_SANITIZERS STREQUAL "thread" )
          ...
          if (  JLN_FLAGS_OTHER_SANITIZERS STREQUAL "memory" )
            if (  ( JLN_CLANG_C_COMPILER AND JLN_C_COMPILER_VERSION VERSION_GREATER_EQUAL "5.0" ) )
  ...
  if (  ( JLN_MSVC_C_COMPILER OR JLN_CLANG_CL_C_COMPILER OR JLN_ICL_C_COMPILER ) )
    ...
    if (   NOT ( JLN_ICL_C_COMPILER ) )
      ...
      if (   NOT ( JLN_FLAGS_PEDANTIC STREQUAL "default" ) )
        if (   NOT ( JLN_FLAGS_PEDANTIC STREQUAL "off" ) )
          list(APPEND CXX_FLAGS  "/permissive-")
        endif()
      endif()
      if (   NOT ( JLN_FLAGS_STACK_PROTECTOR STREQUAL "default" ) )
        if (  JLN_FLAGS_STACK_PROTECTOR STREQUAL "off" )
          ...
          if (  JLN_FLAGS_STACK_PROTECTOR STREQUAL "strong" )
            ...
            if (  ( JLN_MSVC_C_COMPILER AND JLN_C_COMPILER_VERSION VERSION_GREATER_EQUAL "16.7" ) )
  ...
  if (  JLN_MSVC_C_COMPILER )
    ...
    if (   NOT ( JLN_FLAGS_MSVC_CONFORMANCE STREQUAL "default" ) )
      if (  ( JLN_FLAGS_MSVC_CONFORMANCE STREQUAL "all" OR JLN_FLAGS_MSVC_CONFORMANCE STREQUAL "all_without_throwing_new" ) )
        ...
        if (  JLN_C_COMPILER_VERSION VERSION_GREATER_EQUAL "15.6" )
          if (  JLN_C_COMPILER_VERSION VERSION_GREATER_EQUAL "16.5" )
    ...
    if (   NOT ( JLN_FLAGS_MSVC_ISYSTEM STREQUAL "default" ) )
      ...
      if (   NOT ( JLN_FLAGS_WARNINGS STREQUAL "default" ) )
        if (  JLN_FLAGS_WARNINGS STREQUAL "off" )
          ...
          if (  JLN_C_COMPILER_VERSION VERSION_LESS "19.21" )
    ...
    if (   NOT ( JLN_FLAGS_SANITIZERS STREQUAL "default" ) )
      if (  JLN_C_COMPILER_VERSION VERSION_GREATER_EQUAL "16.9" )
