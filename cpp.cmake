...
set(JLN_MSVC_ISYSTEM_WITH_TEMPLATE_INSTANTIATIONS_TREATED_AS_NON_EXTERNAL "${JLN_MSVC_ISYSTEM_WITH_TEMPLATE_INSTANTIATIONS_TREATED_AS_NON_EXTERNAL}" CACHE STRING "Allows warnings from external headers when they occur in a template that's instantiated in your code. (requires `msvc_isystem` option).")
...
function(jln_init_flags)
  jln_parse_arguments(JLN_DEFAULT_FLAG "VERBOSE;ANALYZER;ANALYZER_TOO_COMPLEX_WARNING;ANALYZER_VERBOSITY;BIDI_CHAR_WARNINGS;COLOR;CONVERSION_WARNINGS;COVERAGE;COVERED_SWITCH_DEFAULT_WARNINGS;CPU;DIAGNOSTICS_FORMAT;DIAGNOSTICS_SHOW_TEMPLATE;EMCC_DEBUG;EXCEPTIONS;HARDENED;LINKER;LTO;MSVC_CRT_SECURE_NO_WARNINGS;MSVC_DIAGNOSTICS_FORMAT;MSVC_ISYSTEM;MSVC_ISYSTEM_WITH_TEMPLATE_INSTANTIATIONS_TREATED_AS_NON_EXTERNAL;NDEBUG;NOEXCEPT_WARNINGS;OPTIMIZATION;OPTIMIZATION_WARNINGS;PEDANTIC;REPRODUCIBLE_BUILD_WARNINGS;RTTI;SANITIZERS;SHADOW_WARNINGS;STL_FIX;STL_HARDENING;SUGGEST_ATTRIBUTES;SWITCH_WARNINGS;SYMBOLS;UNSAFE_BUFFER_USAGE_WARNINGS;VAR_INIT;WARNINGS;WARNINGS_AS_ERROR;WINDOWS_ABI_COMPATIBILITY_WARNINGS;WINDOWS_BIGOBJ;AUTO_PROFILE" ${ARGN})
...
function(jln_flags)
  ...
  set(CXX_FLAGS "")
  set(LINK_LINK "")
  jln_parse_arguments(JLN_FLAGS "DISABLE_OTHERS;CXX_VAR;LINK_VAR;ANALYZER;ANALYZER_TOO_COMPLEX_WARNING;ANALYZER_VERBOSITY;BIDI_CHAR_WARNINGS;COLOR;CONVERSION_WARNINGS;COVERAGE;COVERED_SWITCH_DEFAULT_WARNINGS;CPU;DIAGNOSTICS_FORMAT;DIAGNOSTICS_SHOW_TEMPLATE;EMCC_DEBUG;EXCEPTIONS;HARDENED;LINKER;LTO;MSVC_CRT_SECURE_NO_WARNINGS;MSVC_DIAGNOSTICS_FORMAT;MSVC_ISYSTEM;MSVC_ISYSTEM_WITH_TEMPLATE_INSTANTIATIONS_TREATED_AS_NON_EXTERNAL;NDEBUG;NOEXCEPT_WARNINGS;OPTIMIZATION;OPTIMIZATION_WARNINGS;PEDANTIC;REPRODUCIBLE_BUILD_WARNINGS;RTTI;SANITIZERS;SHADOW_WARNINGS;STL_FIX;STL_HARDENING;SUGGEST_ATTRIBUTES;SWITCH_WARNINGS;SYMBOLS;UNSAFE_BUFFER_USAGE_WARNINGS;VAR_INIT;WARNINGS;WARNINGS_AS_ERROR;WINDOWS_ABI_COMPATIBILITY_WARNINGS;WINDOWS_BIGOBJ" ${ARGN})
                ...
                if (  JLN_FLAGS_SANITIZERS STREQUAL "scudo_hardened_allocator" )
                  ...
                  if (  ( JLN_FLAGS_SANITIZERS STREQUAL "on" OR JLN_FLAGS_SANITIZERS STREQUAL "with_minimal_code_size" OR JLN_FLAGS_SANITIZERS STREQUAL "extra" OR JLN_FLAGS_SANITIZERS STREQUAL "extra_with_minimal_code_size" ) )
                    ...
                    if (  ( JLN_FLAGS_SANITIZERS STREQUAL "with_minimal_code_size" OR JLN_FLAGS_SANITIZERS STREQUAL "extra_with_minimal_code_size" ) )
                      if (  ( ( JLN_CLANG_LIKE_COMPILER AND JLN_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "13.0" ) OR ( JLN_CLANG_CL_CXX_COMPILER AND JLN_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "13.0" ) ) )
  ...
  if (  ( JLN_GCC_CXX_COMPILER OR JLN_CLANG_LIKE_COMPILER ) )
    ...
    if (   NOT ( JLN_FLAGS_HARDENED STREQUAL "default" ) )
      if (  ( JLN_FLAGS_HARDENED STREQUAL "on" OR JLN_FLAGS_HARDENED STREQUAL "all" ) )
        if (  ( JLN_GCC_CXX_COMPILER AND JLN_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "14.0" ) )
          ...
          if (  ( ( JLN_GCC_CXX_COMPILER AND JLN_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "12.0" ) OR ( JLN_CLANG_LIKE_COMPILER AND JLN_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "14.0" ) ) )
            list(APPEND CXX_FLAGS  "-D_FORTIFY_SOURCE=3")
            if (  ( ( JLN_GCC_CXX_COMPILER AND JLN_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "13.0" ) OR ( JLN_CLANG_LIKE_COMPILER AND JLN_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "16.0" ) ) )
          ...
          if (   NOT ( JLN_CLANG_EMCC_CXX_COMPILER ) )
            list(APPEND CXX_FLAGS  "-pie")
            list(APPEND LINK_FLAGS  "-pie" "-Wl,-z,relro,-z,now" "-Wl,-z,noexecstack")
          endif()
          if (  JLN_GCC_CXX_COMPILER )
            if (  JLN_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "4.6" )
              list(APPEND CXX_FLAGS  "-Wtrampolines")
              if (  JLN_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "8.0" )
    ...
    if (   NOT ( JLN_ICL_CXX_COMPILER ) )
      ...
      if (   NOT ( JLN_FLAGS_HARDENED STREQUAL "default" ) )
        if (  JLN_FLAGS_HARDENED STREQUAL "off" )
          ...
          if (  ( ( JLN_MSVC_CXX_COMPILER AND JLN_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "19.27" ) OR ( JLN_CLANG_CL_CXX_COMPILER AND JLN_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "10.0" ) ) )
