...
function(jln_flags)
  ...
  if (  ( JLN_GCC_CXX_COMPILER OR JLN_CLANG_CXX_COMPILER OR JLN_CLANG_CL_CXX_COMPILER OR JLN_ICX_CXX_COMPILER ) )
    if (  NOT ( JLN_FLAGS_WARNINGS STREQUAL "default") )
      if (  JLN_FLAGS_WARNINGS STREQUAL "off" )
        ...
        if (  JLN_GCC_CXX_COMPILER )
          ...
          if (  NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "4.7" ) )
          ...
          if (  ( JLN_CLANG_CXX_COMPILER OR JLN_CLANG_CL_CXX_COMPILER OR JLN_ICX_CXX_COMPILER ) )
            ...
            if (  NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "3.9" ) )
              list(APPEND CXX_FLAGS  "-Wno-undefined-var-template")
              if (  NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "5.0" ) )
                list(APPEND CXX_FLAGS  "-Wno-inconsistent-missing-destructor-override")
                if (  NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "9.0" ) )
                  list(APPEND CXX_FLAGS  "-Wno-ctad-maybe-unsupported")
                  if (  NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "10.0" ) )
                    list(APPEND CXX_FLAGS  "-Wno-c++20-compat")
                    if (  NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "11.0" ) )
        ...
        if (  ( JLN_FLAGS_WARNINGS STREQUAL "strict" OR JLN_FLAGS_WARNINGS STREQUAL "very_strict" ) )
          if (  ( JLN_GCC_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "8.0" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_WINDOWS_ABI_COMPATIBILITY_WARNINGS STREQUAL "default") )
      if (  ( ( JLN_GCC_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "10.0" ) ) OR JLN_CLANG_CXX_COMPILER OR JLN_CLANG_CL_CXX_COMPILER OR JLN_ICX_CXX_COMPILER ) )
        ...
        if (  JLN_FLAGS_WARNINGS_AS_ERROR STREQUAL "basic" )
          ...
          if (  JLN_GCC_CXX_COMPILER )
            ...
            if (  ( JLN_CLANG_CXX_COMPILER OR JLN_CLANG_CL_CXX_COMPILER OR JLN_ICX_CXX_COMPILER ) )
              ...
              if (  NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "3.4" ) )
                list(APPEND CXX_FLAGS  "-Werror=logical-not-parentheses")
                if (  NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "3.6" ) )
                  list(APPEND CXX_FLAGS  "-Werror=delete-incomplete")
                  if (  NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "6.0" ) )
      ...
      if (  JLN_FLAGS_SANITIZERS STREQUAL "off" )
        ...
        if (  JLN_CLANG_CL_CXX_COMPILER )
          ...
          if (  JLN_CLANG_CXX_COMPILER )
            if (  NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "3.1" ) )
    ...
    if (  NOT ( JLN_FLAGS_CONTROL_FLOW STREQUAL "default") )
      if (  JLN_FLAGS_CONTROL_FLOW STREQUAL "off" )
        ...
        if (  ( ( JLN_GCC_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "8.0" ) ) OR JLN_CLANG_CL_CXX_COMPILER ) )
    ...
    if (  NOT ( JLN_FLAGS_COLOR STREQUAL "default") )
      if (  ( ( JLN_GCC_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "4.9" ) ) OR JLN_CLANG_CXX_COMPILER OR JLN_CLANG_CL_CXX_COMPILER OR JLN_ICX_CXX_COMPILER ) )
    ...
    if (  NOT ( JLN_FLAGS_REPRODUCIBLE_BUILD_WARNINGS STREQUAL "default") )
      if (  ( JLN_GCC_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "4.9" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_DIAGNOSTICS_FORMAT STREQUAL "default") )
      if (  JLN_FLAGS_DIAGNOSTICS_FORMAT STREQUAL "fixits" )
        if (  ( ( JLN_GCC_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "7.0" ) ) OR ( JLN_CLANG_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "5.0" ) ) OR ( JLN_CLANG_CL_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "5.0" ) ) OR ( JLN_ICX_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "5.0" ) ) ) )
          list(APPEND CXX_FLAGS  "-fdiagnostics-parseable-fixits")
        endif()
      else()
        if (  JLN_FLAGS_DIAGNOSTICS_FORMAT STREQUAL "patch" )
          if (  ( JLN_GCC_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "7.0" ) ) )
  ...
  if (  ( JLN_GCC_CXX_COMPILER OR JLN_CLANG_CXX_COMPILER OR JLN_CLANG_CL_CXX_COMPILER OR JLN_ICX_CXX_COMPILER OR JLN_ICC_CXX_COMPILER ) )
  ...
  if (  ( JLN_GCC_CXX_COMPILER OR JLN_CLANG_CXX_COMPILER ) )
    ...
    if (  NOT ( JLN_FLAGS_LINKER STREQUAL "default") )
      if (  JLN_FLAGS_LINKER STREQUAL "native" )
        ...
        if (  JLN_FLAGS_LINKER STREQUAL "bfd" )
          ...
          if (  ( JLN_FLAGS_LINKER STREQUAL "gold" OR ( JLN_GCC_CXX_COMPILER AND NOT ( NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "9.0" ) ) ) ) )
            list(APPEND LINK_FLAGS  "-fuse-ld=gold")
          else()
    ...
    if (  NOT ( JLN_FLAGS_LTO STREQUAL "default") )
      if (  JLN_FLAGS_LTO STREQUAL "off" )
        ...
        if (  JLN_GCC_CXX_COMPILER )
          ...
          if (  ( JLN_FLAGS_LTO STREQUAL "thin" AND JLN_CLANG_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "6.0" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_WHOLE_PROGRAM STREQUAL "default") )
      if (  JLN_FLAGS_WHOLE_PROGRAM STREQUAL "off" )
        ...
        if (  ( JLN_CLANG_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "3.9" ) ) )
      ...
      if (  JLN_FLAGS_RELRO STREQUAL "off" )
        ...
        if (  JLN_FLAGS_RELRO STREQUAL "on" )
          ...
          if (  JLN_FLAGS_RELRO STREQUAL "full" )
            ...
            if (  NOT ( JLN_FLAGS_LINKER STREQUAL "default") )
              if (  NOT ( ( JLN_FLAGS_LINKER STREQUAL "gold" OR ( JLN_GCC_CXX_COMPILER AND NOT ( NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "9.0" ) ) ) OR ( JLN_FLAGS_LINKER STREQUAL "native" AND JLN_GCC_CXX_COMPILER ) ) ) )
    ...
    if (  NOT ( JLN_FLAGS_STL_DEBUG STREQUAL "default") )
      if (  NOT ( JLN_FLAGS_STL_DEBUG STREQUAL "off" ) )
        ...
        if (  ( JLN_FLAGS_STL_DEBUG STREQUAL "allow_broken_abi" OR JLN_FLAGS_STL_DEBUG STREQUAL "allow_broken_abi_and_bugs" ) )
          if (  JLN_CLANG_CXX_COMPILER )
            if (  ( NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "8.0" ) OR JLN_FLAGS_STL_DEBUG STREQUAL "allow_broken_abi_and_bugs" ) )
    ...
    if (  NOT ( JLN_FLAGS_SHADOW_WARNINGS STREQUAL "default") )
      if (  JLN_FLAGS_SHADOW_WARNINGS STREQUAL "off" )
        ...
        if (  ( JLN_CLANG_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "8.0" ) ) )
        ...
        if (  JLN_FLAGS_SHADOW_WARNINGS STREQUAL "on" )
          ...
          if (  JLN_FLAGS_SHADOW_WARNINGS STREQUAL "all" )
            ...
            if (  ( JLN_GCC_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "7.1" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_ELIDE_TYPE STREQUAL "default") )
      if (  JLN_FLAGS_ELIDE_TYPE STREQUAL "on" )
        ...
        if (  ( ( JLN_GCC_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "8.0" ) ) OR ( JLN_CLANG_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "3.4" ) ) ) )
    ...
    if (  NOT ( JLN_FLAGS_DIAGNOSTICS_SHOW_TEMPLATE_TREE STREQUAL "default") )
      if (  ( ( JLN_GCC_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "8.0" ) ) OR JLN_CLANG_CXX_COMPILER ) )
    ...
    if (  NOT ( JLN_FLAGS_OTHER_SANITIZERS STREQUAL "default") )
      if (  JLN_FLAGS_OTHER_SANITIZERS STREQUAL "thread" )
        ...
        if (  JLN_FLAGS_OTHER_SANITIZERS STREQUAL "memory" )
          if (  ( JLN_CLANG_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "5.0" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_FLOAT_SANITIZERS STREQUAL "default") )
      if (  ( ( JLN_GCC_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "5.0" ) ) OR ( JLN_CLANG_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "5.0" ) ) ) )
      ...
      if (  NOT ( JLN_FLAGS_STACK_PROTECTOR STREQUAL "default") )
        if (  JLN_FLAGS_STACK_PROTECTOR STREQUAL "off" )
          ...
          if (  JLN_FLAGS_STACK_PROTECTOR STREQUAL "strong" )
            ...
            if (  ( JLN_MSVC_CXX_COMPILER AND NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "16.7" ) ) )
  ...
  if (  JLN_MSVC_CXX_COMPILER )
    ...
    if (  NOT ( JLN_FLAGS_MSVC_CONFORMANCE STREQUAL "default") )
      if (  ( JLN_FLAGS_MSVC_CONFORMANCE STREQUAL "all" OR JLN_FLAGS_MSVC_CONFORMANCE STREQUAL "all_without_throwing_new" ) )
        ...
        if (  NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "15.6" ) )
          list(APPEND CXX_FLAGS  "/Zc:externConstexpr")
          if (  NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "16.8" ) )
            list(APPEND CXX_FLAGS  "/Zc:lambda")
            if (  NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "16.5" ) )
    ...
    if (  NOT ( JLN_FLAGS_MSVC_ISYSTEM STREQUAL "default") )
      ...
      if (  NOT ( JLN_FLAGS_WARNINGS STREQUAL "default") )
        if (  JLN_FLAGS_WARNINGS STREQUAL "off" )
          ...
          if (  NOT ( NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "19.21" ) ) )
    ...
    if (  NOT ( JLN_FLAGS_SANITIZERS STREQUAL "default") )
      if (  NOT ( JLN_CXX_COMPILER_VERSION VERSION_LESS "16.9" ) )
    ...
    if (  NOT ( JLN_FLAGS_OPTIMIZATION STREQUAL "default") )
      if (  JLN_FLAGS_OPTIMIZATION STREQUAL "0" )
        ...
        if (  JLN_FLAGS_OPTIMIZATION STREQUAL "g" )
          ...
          list(APPEND CXX_FLAGS  "/DNDEBUG" "/GF")
          if (  JLN_FLAGS_OPTIMIZATION STREQUAL "1" )
            list(APPEND CXX_FLAGS  "/O1")
          else()
            if (  JLN_FLAGS_OPTIMIZATION STREQUAL "2" )
